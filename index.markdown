...
<body>
  <div>
    ...
    <br><br>
    <h3>連絡 | Contact</h3>
     <a href="https://twitter.com/YukyaTaki">X（元Twitter）</a>
     <br>
     yaayuki@gmail.com
    <br><br>
  ...
  <div>
    ...
    <br>
    <br>
    ・<strong>滝 之弥</strong>, 吉田温登, 加藤 邦人, 寺田 和憲: "大規模視覚言語モデルによる特定ドメインに対しての個人の好み判定と判断根拠生成", 動的画像処理実利用化ワークショップ DIA2024 
    <br>
    <br>
    ・第5回 深奥質感 領域班会議 2023年3月13日~3月15日　（ハイブリッド（東京大学福武ホール & Zoom））
    <br>
    <br>
    ・第4回 深奥質感 領域班会議 2022年9月27日~9月29日　（仙台国際センター）
    <br>
    <br>
    ・<strong>滝 之弥1</strong>、加藤 邦人1、寺田 和憲1、 飛谷 謙介2 (1. 岐阜大学、2. 長崎県立大学) "画像に対する感性指標構築とファインチューニングを用いた印象推定"，第28回画像センシングシンポジウム SSII2022，IS3-08，2022.6.10 
    <br>
    <br>
